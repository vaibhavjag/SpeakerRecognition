function fileName=...
   HITtoXML(LogAttackTime, SpectralCentroid, TemporalCentroid, fileName)
...
defaultFileName='PercussiveInstrumentTimbre.xml';
...
%line='<AudioDescriptionScheme xsi:type="mpeg7:PercussiveInstrumentTimbreType">';
line='<DescriptionUnit xsi:type="mpeg7:PercussiveInstrumentTimbreType">';
fprintf(xmlFile,'\t%s\n',line);
